...
export default function StudentProfile() {
  ...
  const openConfirmModal = (studentId) => {
    setDeleteId(studentId); // Set studentId to delete
  ...
  const handleDeleteStudent = async (studentId) => {
    try {
      const response = await fetch(`${BASE_URL}api/student/deleteStudent/${studentId}`, {
        method: "DELETE",
        headers: {
          "Content-Type": "application/json",
          Authorization: localStorage.getItem("token"),
      ...
      if (response.ok) {
        ...
        navigate("/admin/findStudent"); // Redirect to students list page
      } else {
      ...
      <div className="studentprofile">
        <div className="student-profile py-4">
          <div className="student">
            ...
            <button onClick={() => {  console.log("Navigating to edit page for student ID:", studentId);navigate(`/admin/UpdateStudentDetails/${studentId}`)}}>Edit</button> {/* Edit Button */}
            <button onClick={() => openConfirmModal(studentId)}>Delete</button>
            </div>
            {showConfirmModal && (
        <div className="modal-overlay">
          <div className="modal-content">
            <h3 style={{color:"black"}}>Are you sure you want to delete this student?</h3>
            <div className="modal-actions">
              <button
                onClick={() => handleDeleteStudent(deleteId)}
      ...
      <div>
        <Tab>
          ...
          <TabPanel label="Fee Details">
            <div className="panel">
            <button style={{ float: "right" ,background:"blue" }} onClick={handleCollectFees}>Collect Fees</button>
        ...
        {showCheckoutModal && (
          ...
          <CollectFees
            ...
            billingContact={studentData.contact_Number}
            feesData={selectedFees} // Pass the selectedFees array directly
            closeModal={setShowCollectFeesModal}
          />
        )}
